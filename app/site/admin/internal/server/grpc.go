...
func NewGRPCServer(c *conf.Server, logger log.Logger, tp *tracesdk.TracerProvider, s *service.SiteAdminService) *grpc.Server {
	...
	v1.RegisterSiteAdminServiceServer(srv, s)
	return srv
}
