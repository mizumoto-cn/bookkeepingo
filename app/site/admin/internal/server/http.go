...
func NewHTTPServer(c *conf.Server, logger log.Logger, tp *tracesdk.TracerProvider, s *service.SiteAdminService) *http.Server {
	...
	v1.RegisterSiteAdminServiceHTTPServer(srv, s)
	return srv
}
